              ...
              HPDF_REAL         *real_width)
{
    ...
    HPDF_UINT i;
    HPDF_FontAttr attr = (HPDF_FontAttr)font->attr;
//    HPDF_ByteType last_btype = HPDF_BYTE_TYPE_TRIAL;       //CAL:Supress warning "variable ‘last_btype’ set but not used"
    HPDF_Encoder encoder = attr->encoder;
    HPDF_ParseText_Rec  parse_state;
    HPDF_INT dw2;
...
//CAL: commented out next 4 lines to supress warning "variable ‘last_btype’ set but not used"
//        if (HPDF_IS_WHITE_SPACE(b))
