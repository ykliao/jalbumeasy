                         ...
                         png_bytep    smask_data)
{
	...
	HPDF_INT row_len;
	HPDF_UINT i, j;
	png_bytep *row_ptr, row=0; //CAL:Supress warning "‘row’ may be used uninitialized in this function"
	png_byte color_type;
	png_uint_32 height = png_get_image_height(png_ptr, info_ptr);
	png_uint_32 width = png_get_image_width(png_ptr, info_ptr);
              ...
              png_infop    info_ptr)
{
    ...
    HPDF_BYTE *p;
    //HPDF_UINT i;
    HPDF_INT i;         //CAL:Supress 'comparison between signed and unsigned integer expressions' warning
    HPDF_Array array;
