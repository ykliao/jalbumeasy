                     ...
                     HPDF_PageLayout   layout)
{
    ...
    if ((int)layout < 0 || layout >= HPDF_PAGE_LAYOUT_EOF)                     //CAL:Supress "comparison of unsigned expression < 0 is always false" warning
                   ...
                   HPDF_PageMode   mode)
{
    ...
    if ((int)mode < 0 || mode >= HPDF_PAGE_MODE_EOF)                 //CAL:Supress "comparison of unsigned expression < 0 is always false" warning
                    ...
                    const char     *prefix)
{
    ...
    if ((int)style < 0 || style >= HPDF_PAGE_NUM_STYLE_EOF)                   //CAL:Supress "comparison of unsigned expression < 0 is always false" warning
